...
public class RenderHide extends RenderPainting {
	
	public static final ResourceLocation location = new ResourceLocation(Reference.MOD_ID + ":textures/entity/hide.png");
	...
	public void renderThePainting(EntityPainting par1EntityPainting, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        this.func_77010_a(par1EntityPainting, 32, 32, 0, 0);
        GL11.glDisable(GL12.GL_RESCALE_NORMAL);
        GL11.glPopMatrix();
    }
	
	protected void func_77010_a(EntityPainting par1EntityPainting, int par2, int par3, int par4, int par5)
    {
	...
	protected void func_77008_a(EntityPainting par1EntityPainting, float par2, float par3)
    {
