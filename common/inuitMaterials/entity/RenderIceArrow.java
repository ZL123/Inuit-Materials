...
public class RenderIceArrow extends Render {
	...
	private static final ResourceLocation arrowTextures = new ResourceLocation(Reference.MOD_ID + ":textures/entity/iceArrow.png");
	
	public void renderArrow(EntityIceArrow entityArrow, double par2, double par4, double par6, float par8, float par9)
    {
	...
	public void doRender(Entity entity, double d0, double d1, double d2,
			float f, float f1) {
		this.renderArrow((EntityIceArrow)entity, d0, d1, d2, f, f1);
	}
	
	protected ResourceLocation getArrowTextures(EntityIceArrow par1EntityArrow) {
        return arrowTextures;
    }

	@Override
	protected ResourceLocation getEntityTexture(Entity entity) {
		return this.getArrowTextures((EntityIceArrow)entity);
	}
